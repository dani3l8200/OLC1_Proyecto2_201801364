...
class ReportLexico {
    ...
    updateList() {
        for (let index = 0; index < this.tokens.toArray().length; index++) {
            ...
            this.tokenList.append(new Token(element.getIDToken, element.getLexema, element.getType, element.getColumn, element.getRow));
        }
    ...
    getReport() {
        ...
        for (let index = 0; index < this.tokenList.toArray().length; index++) {
            ...
            reportTokens += "<TH>" + element.getLexema + "</TH>";
